...
5. I use the index route of Ride controller for my get all rides in score order by a driver endpoint.  This endpoint is flexiblly engineered to easily allow for also handling the all rides GET route (documented in controller comments), and extending to add other filters.
